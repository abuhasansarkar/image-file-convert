...
export default function BmpToPngPage() {
  ...
  const handleConvert = async () => {
    ...
    for (const file of queuedFiles) {
      try {
        ...
        const result = await convertBmpToPng(file.file, {
          width: options.width,
  ...
  return (
    <ConversionPageTemplate
      ...
      description="Convert bitmap images to compressed PNG format for better file sizes and web compatibility."
      conversionType="bmp-png"
      outputFormat="png"
